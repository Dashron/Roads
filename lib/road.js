 ...
 *
 * You must provide at least one root resource to the constructor. We will check each resource in array order for a matching route. The root resources will handle all requests to the root (`/`) endpoint. Any additional routes will be referenced as sub-resources of the root endpoint.
 * 
