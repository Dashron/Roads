...
/**
 * Find the appropriate find the resource method (route) for the provided resource and method.
 *
 *
 * @param  Resource resource The resource that the parsed_url is mapped to.
 * @param  sring method   The requested HTTP method.
 * @param  string parsed_url The requested url to route, after it has gone through url.parse.  This is necessary for the 404 error alone, It should probably just be removed in favor of a different error message
 * @return function
 */
 ...
 *
 * @todo kill bluebird dependency and use es7 async functions
 * @param  Function fn
 * @return Function
 */
