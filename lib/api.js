 ...
 */
API.prototype._buildRoute = function (parsed_url, request_method, request_body, request_headers) {
	var _self = this;
	var next = null;
	var next_route = null;
 ...
 * @return {[type]}            [description]
 */
API.prototype._locateRoute = function (resource, parsed_url, method) {
...
API.prototype._createCoroutine = function (fn) {
	if (fn.constructor.name === 'GeneratorFunction') {
		return roads.Promise.coroutine(fn);
	} else {
		return fn;
	}
};
 ...
 * @return Promise
 */
API.prototype._executeRoute = function (route) {
	var result = null;
