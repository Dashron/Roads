...
API.prototype.request = function (method, url, body, headers) {
	...
	try {
		...
		// todo: maybe we can make this better, and incorporate it with the locateRoute method
	...
	if (this._onRequest) {
		var next = function (extra_data) {
			return Promise.coroutine(_self.locateRoute(url, method))(url, body, headers, extra_data);
		};
